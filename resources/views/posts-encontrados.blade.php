...
@section('content')
    <h1>Posts de encontrados</h1>

    @if($posts != null)
    <div class="filter-area">
        <form action="{{route('encontrados.filtro')}}" method="POST">
                @csrf
                <h4>Aqui você pode filtrar suas buscas por animais encontrados</h4>
    ...
    @else
        <h3>Infelizmente ainda não encontramos nenhum post de animais encontrados</h3>
    @endif
@endsection
